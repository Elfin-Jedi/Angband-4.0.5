...
RSF(SPIKE,		RST_BOLT | RST_INNATE)
RSF(SHOT_1,		RST_BOLT | RST_INNATE)
RSF(POISON_DART,RST_BOLT | RST_INNATE)
...
RSF(BR_CONF,    RST_BREATH | RST_INNATE)        
...
RSF(BOULDER_1,	RST_BOLT | RST_INNATE)
RSF(BOULDER_2,  RST_BOLT | RST_INNATE)
